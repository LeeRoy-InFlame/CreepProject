...
namespace Player.Inputs
{
    ...
    public class PlayerMovement : MonoBehaviour
    {
        ...
        public bool IsGrouded => _isGrounded;
        ...
        public void JumpingDown(float _verticalDirection, bool _isJumpButtonPressed)
        {
            ...
            if (_rigidbody.linearVelocityY < -1.5f)//во время спрыгивания при достижении этой скорости падения коллайдер должен включаться обратно
            {
